...
- Sure uses a composite key based on transaction content, including date, amount, currency, creditor and debtor information, remittance information, status, and credit/debit indicator
- When `transaction_id` is present, it's also included in the deduplication key
